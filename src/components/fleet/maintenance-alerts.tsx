  ...
  return (
    <>
      {alerts.map((alert) => {
        ...
        return (
          <Alert key={`maint-${alert.vehicleId}-${alert.type}`} variant="destructive" className="bg-yellow-50 border-yellow-200 text-yellow-800 dark:bg-yellow-900/20 dark:border-yellow-800 dark:text-yellow-300">
