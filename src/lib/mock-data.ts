...
export const mockVehicles: Vehicle[] = [
    ...
    { id: '2', placa: 'RBS1A23', modelo: 'VW Gol', cliente: 'Secretaria de Saúde', anoModelo: '2022/2022', valorCompra: 72000, status: 'ativo', empresa: 'HS', dataEntrada: '2022-06-20', totalMaint: 850, maintenances: generateMaintenances(3, '2'), kmAtual: 35000, forSale: true, fipeValue: 70000, photos: ['https://picsum.photos/seed/vwgol/600/400'] },
    ...
    { id: '5', placa: 'PLT7H89', modelo: 'Renault Kwid', cliente: 'Casan', anoModelo: '2023/2024', valorCompra: 65000, status: 'ativo', empresa: 'MJ', dataEntrada: '2023-02-01', totalMaint: 980, maintenances: generateMaintenances(2, '5'), kmAtual: 22000, forSale: true, fipeValue: 63500, photos: ['https://picsum.photos/seed/kwid/600/400'] },
