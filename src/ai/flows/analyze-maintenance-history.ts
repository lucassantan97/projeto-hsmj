...
export const MaintenanceAnalysisOutputSchema = z.object({
  analysis: z.string().describe(
    "A brief, insightful analysis of the vehicle's maintenance history, pointing out patterns, potential future issues, and overall health. Use Markdown for formatting."
  ),
});
